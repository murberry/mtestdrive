...
<head>
  ...
  <style>
  	.light-login {
    background: #dfe0e2 url(images/logo_bg.jpg) repeat;
}
  </style>
</head>
    ...
    ">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            <h1 id="id-text2" class="grey" style="color:#FFF !important">
                 ...
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        ...
                        <button style="background:#0f1d3a !important;border-color:#0f1d3a !important" type="button" id="but_login"  onclick="checkUser()" class="width-35 pull-right btn btn-sm btn-primary">
