	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
                ...
                <input id="departname" name="departname" type="text" readonly="readonly" class="inputxt" disabled="disabled" value="玛莎拉蒂GPS试驾系统,">
                <input id="orgIds" name="orgIds" type="hidden" value="297e25b75b27a70b015b28039a0d000f,">
		...
		<tr>
			...
			<td class="value" nowrap>
                ...
                <c:if test="${roleName == '系统管理员' }">
                	<input name="roleid" name="roleid" type="hidden" value="297e25b75aef86b1015aef89d7db000f" id="roleid">
                	<input name="roleName" class="inputxt" value="超级管理员" id="roleName" readonly="readonly"  />
                	<input name="userKey" type="hidden" value="超级管理员" id="userKey">
                </c:if>
                <c:if test="${roleName == '超级系统管理员' }">
                	<input name="roleid" name="roleid" type="hidden" value="2c9a4cf95b6c00c2015b6c1cdd370060" id="roleid">
                	<input name="roleName" class="inputxt" value="系统管理员" id="roleName" readonly="readonly"  />
                	<input name="userKey" type="hidden" value="系统管理员" id="userKey">
                </c:if>
