...
function update(title,url, id,width,height,isRestful) {
	...
	var userKey = rowsData[0].userKey;
	var curtUserKey = '${curtUserKey}';
	if(curtUserKey == '系统管理员' && userKey != '超级管理员')
		tip("对不起，您没有权限修改"+userKey+"!");
	else if(curtUserKey == '超级系统管理员'  && userKey != '系统管理员')
		tip("对不起，您没有权限修改"+userKey+"!");
	else
