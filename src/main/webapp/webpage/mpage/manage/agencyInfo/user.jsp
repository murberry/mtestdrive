...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="agencyInfoController.do?saveUser" beforeSubmit="setOrgIds">
		...
		<tr>
			...
			<td class="value" width="85%">
                ...
                <c:if test="${user.id==null }">
                	<input name="agenctid" value="${agenctid}" type="hidden">
                    <input id="userName" class="inputxt" name="userName" validType="t_s_base_user,userName,id" value="${user.userName }" datatype="s5-100" />
                    <span class="Validform_checktip"> 用户名长度大于等于5</span>
                </c:if>
            </td>
		</tr>
		<tr>
			...
			<td class="value" width="10%">
                <input id="realName" class="inputxt" name="realName" value="${user.realName }" datatype="s2-100">
                <span class="Validform_checktip">用户名长度大于等于2</span>
            </td>
		</tr>
		<c:if test="${user.id==null }">
			<tr>
