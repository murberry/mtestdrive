...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center"  style="padding:0px;border:0px">
        <t:datagrid name="noCurDepartUserList" title="common.operation"
                    actionUrl="agencyInfoController.do?addUserToOrgList&orgId=${orgId}" fit="true" fitColumns="true"
...
<div style="display: none">
    <t:formvalid formid="formobj" layout="div" dialog="true" action="agencyInfoController.do?doAddUserToOrg&orgId=${orgId}" beforeSubmit="setUserIds">
