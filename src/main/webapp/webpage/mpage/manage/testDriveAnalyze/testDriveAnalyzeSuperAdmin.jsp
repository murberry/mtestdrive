...
<body style="overflow: scroll;">
	<div name="searchColums" style="text-align: center; height: 30px; line-height: 40px;margin-bottom: 20px;">
		...
		<select id="dimension" class="weidu_super_admin" onchange="analyze()">
			<option value="store">全国</option>
			<option value="quyu">集团</option>
			<option value="motorcycle">车型</option>
		</select> 
		<%-- <t:dictSelect field="regionId" id="region" typeGroupCode="dearlerGroup" hasLabel="false"></t:dictSelect> --%>
