...
<link rel="shortcut icon" href="images/mtestico.ico">
	...
	<div id="wrapper">
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="plug-in/login/images/touxiang.png" width="60px" height="60px"/></span> <a
								data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
								class="clear"> <span class="block m-t-xs"><strong
										class="font-bold">${userName }</strong></span> <span
									class="text-muted text-xs block">${roleName }<b
										class="caret"></b></span>
							</span>
							</a>
						...
						<div class="logo-element">玛莎拉蒂试驾管理系统</div>
					</li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row border-bottom">
				<nav class="navbar navbar-static-top" role="navigation"
					...
					<div style="margin:auto;   text-align: center;">
						<img alt="" src="plug-in/login/images/logo.png" style="margin: 5px 0px 8px 0px;">
					</div>
					...
					<!-- <div class="navbar-header" style="height: 60px;">
						...
						<form role="search" class="navbar-form-custom" method="post"
							...
							<div class="form-group">
								<input type="text" placeholder="欢迎使用玛莎拉蒂试驾系统" class="form-control" name="top-search" id="top-search">
							</div>
						</form>
					</div> -->
					<ul class="nav navbar-top-links navbar-right" style="display: none">
							...
							<ul class="dropdown-menu dropdown-alerts">
								...
								<li>
									<div class="text-center link-block">
										<a class="" href="javascript:goAllNotice();"> <i
						...
						<li class="dropdown"><a class="dropdown-toggle count-info"
							...
							<ul class="dropdown-menu dropdown-alerts">
								...
								<li>
									<div class="text-center link-block">
										<a class="" href="javascript:goAllMessage();"> <strong>查看所有
			...
			<div class="row content-tabs">
				...
				<nav class="page-tabs J_menuTabs">
					...
					<button class="roll-nav roll-right J_tabRight" style="display:none">
					...
					<a href="javascript:logout()" class="roll-nav roll-right J_tabExit" style="width: auto;"><i
		...
		<div id="right-sidebar">
			<div class="sidebar-container">
				...
				<ul class="nav nav-tabs navs-3" style="display: none">
						...
						<div>
								...
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a1.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a2.jpg">
									</div>
									<div class="media-body">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a3.jpg">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a4.jpg">
									</div>
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a8.jpg">
									</div>
									<div class="media-body">
							...
							<div class="sidebar-message">
								<a href="#">
									<div class="pull-left text-center">
										<img alt="image" class="img-circle message-avatar"
											src="plug-in-ui/hplus/img/a7.jpg">
									</div>
									<div class="media-body">
