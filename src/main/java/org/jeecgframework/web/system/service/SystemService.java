...
public interface SystemService extends CommonService{
	...
	String excuteProdurce(String sql, final String obj1, final String obj2);
	String excuteProdurce2(String sql, final String obj1, final String obj2, final String obj3);
}
